...
function confirmDelete(event) {
    ...
    const userConfirmed = confirm("Você tem certeza que deseja excluir sua conta?");
    if (userConfirmed) {
...
<body class="w-full">
	<div class="w-full max-w-[353px] mx-auto flex flex-col items-center justify-center py-6">
		...
		<form method="post" action="update-profile" class="w-full flex flex-col gap-3">
			...
			<div class="flex flex-col gap-2">
				<label for="address" class="text-lg text-neutral-200 font-semibold">Endereço residencial</label> 
			...
			<div class="flex flex-col gap-2">
				<label for="username" class="text-lg text-neutral-200 font-semibold">Nome de usuário</label> 
			...
			<div class="flex flex-col gap-2">
				<label for="gender" class="text-lg text-neutral-200 font-semibold">Gênero</label>
